<x-layouts.app title="Echoes · SOL4">
    <div class="flex w-full flex-col gap-6" aria-label="Text posts">
        ...
        @empty
            <div class="w-full rounded-sol border border-dashed border-sol-line bg-sol-panel p-10 text-center">
                ...
                <h2 class="font-display text-2xl font-bold text-sol-night">No echoes yet</h2>
                <p class="mt-2 font-body text-sm text-sol-muted">The first text signal has not reached Mars yet.</p>
            </div>
        @endforelse
    </div>
</x-layouts.app>
